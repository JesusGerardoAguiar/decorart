        ...
        <Link to="/proyectos">
          <ProcessDiv id="projects">
            <ProccessTextDiv>
              <h1>Proyectos</h1>
              <p>
                Lo importante en un retapizado es distinguir si vale la pena o
                no invertir en un mueble usado. Cuando el sofa fue bien armado
                desde el origen y con buenos materiales siempre vale la pena
                invertir en retapizar. <br />
                <br />
                Como nos damos cuenta si fue bueno armado en origen? por lo
                general su estructura no tiene movimientos y sus materiales
                aunque hayan perdido densidad siguen estando en uso.
                <br />
                <br />
                Lo que no sirve retapizar es el tipo de muebles que fue armado
                de una manera mas standar. Nuestro retapizados se desraman por
                completo, no se forran encima, desarmamos y volvemos a armar con
                materiales nuevos y de muy buena calidad.
                <br />
                <br /> Tenemos la obligacion que si hacemos gastar a un cliente
                en arreglar un mueble y gaste en una muy buena tela o cuero, la
                estructura y armado debe acompanar la duracion de dichos
                materiales.
              </p>
            </ProccessTextDiv>
